...
class RNNnet (nn.Module):
	...
	def init_hidden(self):
		return (autograd.Variable(torch.zeros(2, self.batchSize, self.hiddenDim)),
                autograd.Variable(torch.zeros(2, self.batchSize, self.hiddenDim)))			
...
# inintalize hidden state at the beginning
